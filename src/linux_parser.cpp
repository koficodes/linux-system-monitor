...
// The code below was commented out because they are not required
// for the over all function of the project,
// The needed jiffies are obtained and in the respective functions
